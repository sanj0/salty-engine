 ...
 * <p>
 * Based on a {@link #tileSize tile size} and an
 * {@link #origin}, you may obtain a {@link
 * de.edgelord.saltyengine.transform.Transform}
 * according to a given grid position and width
 * and height using {@link #getTransform(int, int,
 * int, int)} or {@link #getTransform(Coordinates,
 * Dimensions)}.
 * <p>
 * You may also obtain the <code>Transform</code>
 * of a single tile at a given position using
...
public class Grid {
     ...
     *
     * @param tileSize the {@link #tileSize size
     *                 of one tile}
     * @param origin   the {@link #origin origin
     *                 of the grid}
     */
     ...
     * @param originX    the x position of the
     *                   origin of the grid
     * @param originY    the y position of the
     *                   origin of the grid
     */
     ...
     * {@link #tileSize tile size} and an {@link
     * #origin} at {@link Vector2f#zero()}.
     *
     * @param tileSize the {@link #tileSize size
     *                 of one tile}
     */
    ...
    /**
     * Returns a {@link Transform} that resembles
     * the given parameters with this grid as the
     * system of coordinates.
     *
     * @param position   the coordinates of the
     *                   tile that is giving the
     *                   returned <code>Transform</code>
     *                   its position
     * @param dimensions the <code>Dimensions</code>
     *                   of the returned
     *                   <code>Transform</code>
     *                   in
     *                   tiles
     *
     * @return a {@link Transform} that resembles
     * the given parameters with the grid as the
     * system of coordinates
     */
    ...
    /**
     * Calls {@link #getTransform(Coordinates,
     * Dimensions)} to return a {@link Transform}
     * that resembles the given parameters with
     * this grid as the system of coordinates.
     *
    ...
    /**
     * Returns a {@link Transform} with the
     * following values:
     * <p>
     * - the {@link Vector2f position} of the tile
     * with the given coordinates within this grid
     * - the {@link Dimensions dimensinos} of on
     * tile, which is {@link #tileSize}
     *
     * @param x the x position of the tile within
     *          this grid
     * @param y the y position of the tile within
     *          this grid
     *
     * @return the <code>Transform</code> of the
     * tile with the given {@link Coordinates}
     * within this grid
     */
     ...
     * Sets {@link #origin}.
     *
     * @param origin the new value of {@link
     *               #origin}
     */
