...
public class SaltyVolatileImage implements SaltyImage {
    ...
    /**
     * Creates a new instance with the image located at the given path relative
     * to the project root. The image is obtained using {@link
     * SaltySystem#defaultImageFactory}.
     *
