...
/**
 * An interface that can modify individual {@link Particle}s in any way, like
 * e.g. its speed or size or even manipulate it directly by moving it. An {@link
 * EmitterComponent} has a list of them stored in and used from {@link
...
public interface ParticleModifier {
    ...
    /**
     * Calls {@link #modifyParticle(Particle)} for every {@link Particle} in the
     * given list.
     *
