 ...
 * <p>
 * Based on a {@link #tileSize tile size} and an {@link #origin}, you may obtain a {@link de.edgelord.saltyengine.transform.Transform}
 * according to a given grid position and width and height using
 * {@link #getTransform(int, int, int, int)} or {@link #getTransform(Coordinates, Dimensions)}.
 * <p>
 * You may also obtain the <code>Transform</code> of a single tile at a given position using {@link #getTile(int, int)}.
 */
public class Grid {
    ...
    /**
     * Returns a {@link Transform} that resembles the given
     * parameters with this grid as the system of coordinates.
     *
     * @param position   the coordinates of the tile that is giving
     *                   the returned <code>Transform</code> its position
    ...
    /**
     * Calls {@link #getTransform(Coordinates, Dimensions)} to return a {@link Transform} that resembles the given
     * parameters with this grid as the system of coordinates.
     *
     * @param x      the x position of the returned <code>Transform</code> within the grid
     * @param y      the y position of the returned <code>Transform</code> within the grid
     * @param width  the width of the returned <code>Transform</code> given as number of tiles
     * @param height the height of the returned <code>Transform</code> given as number of tiles
     * @return a {@link Transform} that resembles the given parameters with the grid as the system of coordinates
