...
/**
 * A textbox that displays text (e.g. dialog) in front of a static background.
 * The background is a screenshot of the game at the exact moment the
 * constructor is invoked.
 * <p>
 * Newlines in the text are marked by {@code \n} while new "pages" of the box
 * are to be marked by {@code \f}.
 * <p>
 * While this Scene is active, any input handlers in {@link Input} are
 * disabled.
 */
public class StaticBackgroundTextbox extends Scene {
    ...
    /**
     * The constrcutor with all necessary parameters. All other parameters can
     * be added with the method prefixed by {@code with}.
     *
     * @param text            the text
     * @param transform       the transform of the box around (below) the text
     * @param sceneToReturnTo the Scene that is being returned to after the last
     *                        page of the textbox
     */
