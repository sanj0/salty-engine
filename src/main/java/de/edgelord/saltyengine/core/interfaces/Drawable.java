...
/**
 * A <code>Drawable</code> is an object than can be drawn using a {@link
 * SaltyGraphics SaltyGraphics object}.
 */
public interface Drawable {

    /**
     * Returns a <code>Drawable</code> that sets the color of the graphics to
     * the given.
     *
     * @param color the color to set the graphics to
     *
     * @return a <code>Drawable</code> that sets the color of the graphics to
     * the given.
     */
    ...
    /**
     * Returns a <code>Drawable</code> that sets the paint of the graphics to
     * the given.
     *
     * @param paint the paint to set the graphics to
     *
     * @return a <code>Drawable</code> that sets the paint of the graphics to
     * the given.
     */
    ...
    /**
     * Returns a <code>Drawable</code> that sets the stroke of the graphics to
     * the given.
     *
     * @param stroke the stroke to set the graphics to
     *
     * @return a <code>Drawable</code> that sets the stroke of the graphics to
     * the given.
     */
