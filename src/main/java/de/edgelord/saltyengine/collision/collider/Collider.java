...
/**
 * A class that defines when a {@link GameObject} collides with another. The
 * default ({@link GameObject#getCollider() collider}) is a {@link
 * HitboxCollider}.
 * <p>
 * This class is used by the {@link SceneCollider} of the {@link
 * de.edgelord.saltyengine.scene.Scene}. With the default one being {@link
 * PrioritySceneCollider}, when checking the collision between two
 * <code>GameObject</code>s, the <code>Collider</code> with the higher {@link
 * #priority} is taken.
 */
public abstract class Collider {
    ...
    /**
     * Returns the {@link Collider} of the given two, that isn't
     * <code>this</code>.
     *
     * @param collider1 the first collider
     * @param collider2 the second collider
     *
     * @return the one <code>Collider</code> from the given two that isn't
     * <code>this</code>.
     */
    ...
    /**
     * Checks whether the two given {@link GameObject}s collide or not. Returns
     * the result as {@link CollisionDetectionResult}.
     *
