...
package de.edgelord.saltyengine.graphics.camera;
 ...
 * <p>
 * A camera, in this sense, takes input and generate an according {@link
 * de.edgelord.saltyengine.graphics.image.SaltyImage image}.
 */
public interface Camera {
     ...
     *
     * @return a visual representation of the given Drawable as this camera sees
     * it
     */
    ...
    /**
     * Returns the rotation of this camera as set and described in {@link
     ...
     * <p>
     * This does not affect the size of the output produced with {@link
     * #render(Drawable)}.
     *
     ...
     * #getPosition() position} <br> {@link #getRotation() rotation} <br>
     *
    ...
    /**
     * Returns the position of the given Vector relative to the position of the
     * camera. Example:
     *
     * <pre>
     *     {@code
     ...
     *
     * @return the absolute position with considering the position of this
     * camera for the given relative position
     */
    ...
    /**
     * Returns the cursor as a {@link Transform} manipulated in a way that it
     * fits the camera position. You can obtain this value easier by using
     * {@link Input#getCursor()}
     *
    ...
    /**
     * Returns the cursor position relative to the camera position. You can
     * obtain this value easier by using {@link Input#getCursorPosition()} ()}.
     *
     * @return the cursor position manipulated in a way that it fits the
