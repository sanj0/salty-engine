...
/**
 * A {@link de.edgelord.saltyengine.emitter.ParticleModifier} that extends {@link SpeedOperatorParticleModifier}
 * so that it modifies the {@link Particle}'s rotation instead of its speed.
 */
