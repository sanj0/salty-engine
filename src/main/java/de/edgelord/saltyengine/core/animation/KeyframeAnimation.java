...
/**
 * An abstract implementation of the <code>Keyframe animation</code> concept.
 */
public abstract class KeyframeAnimation {
    ...
    /**
     * A map of relative values to timecode generated by
     * {@link #calculateAnimation()}
     */
    ...
    /**
     * The current frame, manipulable by {@link #setCurrentFrame(int)} and {@link #restart()}
     */
    private int currentFrame = -1;

    /**
     * Stores whether there were changes made to {@link #keyframes the list of KeyFrames}
     * since the last {@link #calculateAnimation() calculation} or not
     */
    ...
    /**
     * A constructor to initialize and empty <code>KeyframeAnimation</code>
     */
    ...
    /**
     * Return <code>true</code> if and only if the <br>
     * {@link #currentFrame} is smaller than the {@link #end} - 1
     *
     * @return <code>true</code> if the animation has ended and therefore reached the last
     * frame and <code>false</code> if not.
     */
    ...
    /**
     * Adds the given <code>Keyframe</code> to the
     * {@link #keyframes list}.
     *
    ...
    /**
     * Adds a new <code>Keyframe</code> to the
     * {@link #keyframes list} with the given timecode
     * and value.
     *
