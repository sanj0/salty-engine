...
public class Positions {
    ...
    /**
     * Returns the x position in user-space for the given decimal.
     * 0f would be the position 0 in user-space as well and 1f would be
     * the right edge of the game-width specified by {@link Game#getGameWidth()}.
     *
    ...
    /**
     * Returns the y position in user-space for the given decimal.
     * 0f would be the position 0 in user-space as well and 1f would be
     * the right edge of the game-height specified by {@link Game#getGameHeight()} ()}.
     *
     * @param decimalPos the position as a decimal number
     * @return the true position in user-space
     */
    ...
    /**
     * Returns a new {@link Coordinates2f} that represents the given decimal position in
     ...
     * @return a new {@link Coordinates2f} representing the given decimal position in user-space
     * @see #xForDecimal(float)
     * @see #yForDecimal(float)
     */
    public static Coordinates2f forDecimal(float xDecimal, float yDecimal) {
        return new Coordinates2f(xForDecimal(xDecimal), yForDecimal(yDecimal));
    }
    ...
    /**
     * Returns a new {@link Coordinates2f} that represents the given percentage-position in
     * coordinates in user-space.
     *
     * @param xPercentage the x position as percentage
     * @param yPercentage the y position as percentage
     * @return a new {@link Coordinates2f} representing the given percentage-position in user-space
     * @see #xForPercentage(float)
     * @see #yForPercentage(float)
     */
    public static Coordinates2f forPercentage(float xPercentage, float yPercentage) {
        return new Coordinates2f(xForPercentage(xPercentage), yForPercentage(yPercentage));
    }
}
