...
public abstract class Light implements TransformedObject {
    ...
    /**
     * The brightness of the alpha-blend of this light, between 1f and 1f, with
     * 0f being completely dark and 1f being max bright
     */
    private float brightness = .35f;

    /**
     * The intensity of this light, influences e.g. the gradient of a {@link
     * GradientLight}
     */
    ...
    /**
     * The start alpha value of the gradient with color being drawn over the
     * light. 0 is min, 255 is max.
     */
    ...
    /**
     * Draws the visuals of this light without color onto the given {@link
     * Graphics2D graphics} of the {@link LightSystem}.
     *
    ...
    /**
     * Draws the colored part of the visuals of the light to the given {@link
     * Graphics2D graphics} of the {@link LightSystem}. <p> Together with {@link
     * #draw(Graphics2D)}, this completes the visuals of this
     * <code>Light</code>
     *
