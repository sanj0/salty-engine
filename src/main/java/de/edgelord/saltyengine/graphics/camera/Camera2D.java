...
public class Camera2D implements Camera, TransformedObject {
    ...
    /**
     * Moves the camera by the given amount in the given direction in
     * userspace.
     *
     * @param direction the {@link de.edgelord.saltyengine.utils.Directions.Direction}
     *                  of the movement. Actually, there is no camera movement
     *                  simulated and all of the rendered entities will move in
     *                  this direction instead of the camera to move.
