...
public class BasicRenderContext implements RenderContext {
    ...
    /**
     * The Color with which to render. <br> It may be set using {@link
     * #setColor(Color)} and may be obtained using {@link #getColor()}
     */
    private Color color;

    /**
     * The Paint with which to render. <br> It may be set using {@link
     * #setPaint(Paint)} and may be obtained using {@link #getPaint()}
     */
    private Paint paint;

    /**
     * The Stroke to use for rendering. <br> It may be set using {@link
     * #setStroke(Stroke)} and may be obtained using {@link #getStroke()}
     */
    private Stroke stroke;

    /**
     * The alpha value of the color, separated for easier control. The value may
     * range from 0f to 1f. <br> It may be set using {@link #setAlpha(float)}
     * and may be obtained using {@link #getAlpha()}
     */
    private float alpha = 1f;

    /**
     * The font to use. This is already pre-defined, as it may never vary over
     * the whole rendering process. As well, this is excluded from the {@link
     * #applyConfiguration(SaltyGraphics)} implementation. <br> It may be set
     * using {@link #setFont(Font)} and may be obtained using {@link
     * #getFont()}
     */
    ...
    /**
     * Returns the {@link #color} used by this {@link RenderContext} with its
     * own alpha value instead of the {@link #alpha} value hold by this. To get
     * the {@link Color} with the correct alpha value, use {@link
     * #getColorWithAlpha()}.
     *
    ...
    /**
     * Applies the graphics configurations described by this context to the
     * given graphics and returns previous one.
     *
