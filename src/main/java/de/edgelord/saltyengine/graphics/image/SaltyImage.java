...
public interface SaltyImage {
    ...
    /**
     * Draws the given {@link Drawable} to the image using {@link
     * Drawable#draw(SaltyGraphics)} like so: {@code drawable.draw(getGraphics())}.
     *
    ...
    /**
     * Clears the content of this image with a {@link de.edgelord.saltyengine.utils.ColorUtil#TRANSPARENT_COLOR
     * transparent color}.
     */
    default void erase() {
