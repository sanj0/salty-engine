...
import de.me.edgelord.sjgl.sgs.segments.*;

import java.awt.*;

/**
 * This class interprets salty gameObject scripting (sgs) scripts by doing whatever the next script-line says, e.g. move
