...
public @interface DefaultPlacement {
    ...
    enum Method {
        ...
        CENTRE,
        /**
         * The method of placement when the object has the same position (and
         * dimensions) as its parent (e.g. components).
         */
        PARENT,
        /**
         * The method of placement when the object is placed relative to its
         * parent using the {@link de.edgelord.saltyengine.utils.TransformRelationUtil}.
         */
        TRANSFORM_RELATION
    }
}
