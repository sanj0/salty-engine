 ...
 * which does the following (maybe expand in the future):
 * <p>
 * - when the window is closing:
 * <p>
 * - calls {@link GameListener#onClose()} on all assigned
 * <code>GameListener</code>s
 * <br>
 * - run the shutdown hooks by calling {@link WindowClosingHooks#runHooks()}
 * <br>
 * - close the {@link de.edgelord.saltyengine.core.Engine} by calling {@link
 * Engine#close()} to {@link Game#getEngine()}
 * <br>
