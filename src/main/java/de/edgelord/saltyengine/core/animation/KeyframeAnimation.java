...
public abstract class KeyframeAnimation {
    ...
    /**
     * A map of relative values to timecode
     * generated by {@link #calculateAnimation()}
     */
    ...
    /**
     * The current frame, manipulable by {@link
     * #setCurrentFrame(int)} and {@link
     * #restart()}
     */
    private int currentFrame = -1;

    /**
     * Stores whether there were changes made to
     * {@link #keyframes the list of KeyFrames}
     * since the last {@link #calculateAnimation()
     * calculation} or not
     */
    ...
    /**
     * A constructor that initializes the {@link
    ...
    /**
     * Important: This method only returns a delta
     * value!
     *
     * @return the next delta-step of the linear
     * keyframe animation
     */
    ...
    /**
     * Fills the {@link #animation} with
     * timecode-to-delta values.
     */
    public abstract void calculateAnimation();

    /**
     * Sorts the {@link #keyframes} by their
     * timecode and sets the {@link #end}.
     */
     ...
     * has ended and therefore reached the last
     ...
     * {@link #keyframes list} with the given
     * timecode and value.
     *
     ...
     * Sets {@link #keyframes}.
     *
     * @param keyframes the new value of {@link
     *                  #keyframes}
     */
