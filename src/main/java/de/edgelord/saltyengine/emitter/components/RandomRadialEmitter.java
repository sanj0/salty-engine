...
/**
 * An emitter that spawns its {@link Particle}s at the centre of its parent and
 * gives them a random rotation between 0 and 360 degrees. {@link
 * #lockedDirections} are the directions in which the particles can't move.
 */
