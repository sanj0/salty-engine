...
/**
 * A {@link GFXComponent} that is designed for the use with the {@link
 * Game#getDefaultGFXController() default GFXController}.
 */
public abstract class SceneGFXComponent extends GFXComponent {

    /**
     * The constructor. Adds this <code>Component</code> to the {@link
     * Game#getDefaultGFXController() default GFXController}.
     *
