...
/**
 * This implementation of {@link SceneCollider} takes the result from the {@link
 * Collider} with the highest {@code priority}.
 */
public class PrioritySceneCollider implements SceneCollider {

    /**
     * Returns the return value of {@link Collider#checkCollision(GameObject,
     * GameObject)} from the <code>Collider</code> with the highest priority
     * (which most likely means the highest accuracy).
     *
